...
myBgMap = mapmisc::openmap(hgm)
data('worldMap', package='mapmisc')
worldMap = project(unwrap(worldMap), mapmisc::crsLL)
```

```{r firstPlot, fig.cap='data plot', fig.subcap = c('hg', names(covList)), echo=FALSE, cache=TRUE}
mapmisc::map.new(hgm)
